...
-export_type(['point'/0, 'rectangle'/0, 'route_note'/0, 'route_summary'/0, 'feature'/0]).

-spec encode_msg(point() | rectangle() | route_note() | route_summary() | feature(),point | rectangle | route_note | route_summary | feature) -> binary().
encode_msg(Msg, MsgName) ->
    encode_msg(Msg, MsgName, []).


-spec encode_msg(point() | rectangle() | route_note() | route_summary() | feature(),point | rectangle | route_note | route_summary | feature, list()) -> binary().
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      rectangle -> e_msg_rectangle(Msg, TrUserData);
      route_note -> e_msg_route_note(Msg, TrUserData);
      route_summary -> e_msg_route_summary(Msg, TrUserData);
      feature -> e_msg_feature(Msg, TrUserData)
    end.
...
e_msg_rectangle(Msg, TrUserData) ->
    e_msg_rectangle(Msg, <<>>, TrUserData).


e_msg_rectangle(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{lo := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
e_msg_route_note(Msg, TrUserData) ->
    e_msg_route_note(Msg, <<>>, TrUserData).


e_msg_route_note(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{location := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
e_msg_route_summary(Msg, TrUserData) ->
    e_msg_route_summary(Msg, <<>>, TrUserData).


e_msg_route_summary(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{point_count := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
e_msg_feature(Msg, TrUserData) ->
    e_msg_feature(Msg, <<>>, TrUserData).


e_msg_feature(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{name := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      rectangle ->
	  v_msg_rectangle(Msg, [rectangle], TrUserData);
      route_note ->
	  v_msg_route_note(Msg, [route_note], TrUserData);
      route_summary ->
	  v_msg_route_summary(Msg, [route_summary], TrUserData);
      feature -> v_msg_feature(Msg, [feature], TrUserData);
      _ -> mk_type_error(not_a_known_message, Msg, [])
    end.


-dialyzer({nowarn_function,v_msg_point/3}).
v_msg_point(#{} = M, Path, _) ->
    case M of
      #{latitude := F1} ->
...
get_msg_names() ->
    [point, rectangle, route_note, route_summary, feature].
