...
-export_type(['bool_value'/0, 'payload'/0, 'streaming_input_call_request'/0, 'reconnect_params'/0, 'echo_status'/0, 'response_parameters'/0, 'streaming_output_call_request'/0, 'empty'/0, 'simple_request'/0, 'simple_response'/0, 'streaming_output_call_response'/0, 'streaming_input_call_response'/0, 'reconnect_info'/0]).

-spec encode_msg(bool_value() | payload() | streaming_input_call_request() | reconnect_params() | echo_status() | response_parameters() | streaming_output_call_request() | empty() | simple_request() | simple_response() | streaming_output_call_response() | streaming_input_call_response() | reconnect_info(),bool_value | payload | streaming_input_call_request | reconnect_params | echo_status | response_parameters | streaming_output_call_request | empty | simple_request | simple_response | streaming_output_call_response | streaming_input_call_response | reconnect_info) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      bool_value -> e_msg_bool_value(Msg, TrUserData);
      payload -> e_msg_payload(Msg, TrUserData);
      streaming_input_call_request ->
	  e_msg_streaming_input_call_request(Msg, TrUserData);
      reconnect_params ->
	  e_msg_reconnect_params(Msg, TrUserData);
      echo_status -> e_msg_echo_status(Msg, TrUserData);
      response_parameters ->
	  e_msg_response_parameters(Msg, TrUserData);
      streaming_output_call_request ->
	  e_msg_streaming_output_call_request(Msg, TrUserData);
      empty -> e_msg_empty(Msg, TrUserData);
      simple_request -> e_msg_simple_request(Msg, TrUserData);
      simple_response ->
	  e_msg_simple_response(Msg, TrUserData);
      streaming_output_call_response ->
	  e_msg_streaming_output_call_response(Msg, TrUserData);
      streaming_input_call_response ->
	  e_msg_streaming_input_call_response(Msg, TrUserData);
      reconnect_info -> e_msg_reconnect_info(Msg, TrUserData)
    end.



e_msg_bool_value(Msg, TrUserData) ->
    e_msg_bool_value(Msg, <<>>, TrUserData).


e_msg_bool_value(#{} = M, Bin, TrUserData) ->
    case M of
      #{value := F1} ->
	  begin
...
e_msg_payload(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{type := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
e_msg_streaming_input_call_request(Msg, TrUserData) ->
    e_msg_streaming_input_call_request(Msg, <<>>,
				       TrUserData).


e_msg_streaming_input_call_request(#{} = M, Bin,
				   TrUserData) ->
    B1 = case M of
	   #{payload := F1} ->
	       begin
...
e_msg_reconnect_params(#{} = M, Bin, TrUserData) ->
    case M of
...
e_msg_echo_status(Msg, TrUserData) ->
    e_msg_echo_status(Msg, <<>>, TrUserData).


e_msg_echo_status(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{code := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
e_msg_response_parameters(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{size := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
e_msg_streaming_output_call_request(Msg, TrUserData) ->
    e_msg_streaming_output_call_request(Msg, <<>>,
					TrUserData).


e_msg_streaming_output_call_request(#{} = M, Bin,
				    TrUserData) ->
    B1 = case M of
	   #{response_type := F1} ->
	       begin
...
e_msg_simple_request(Msg, TrUserData) ->
    e_msg_simple_request(Msg, <<>>, TrUserData).


e_msg_simple_request(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{response_type := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
e_msg_simple_response(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{payload := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
e_msg_streaming_output_call_response(Msg, TrUserData) ->
    e_msg_streaming_output_call_response(Msg, <<>>,
					 TrUserData).


e_msg_streaming_output_call_response(#{} = M, Bin,
				     TrUserData) ->
    case M of
      #{payload := F1} ->
	  begin
...
e_msg_streaming_input_call_response(Msg, TrUserData) ->
    e_msg_streaming_input_call_response(Msg, <<>>,
					TrUserData).


e_msg_streaming_input_call_response(#{} = M, Bin,
				    TrUserData) ->
    case M of
...
e_msg_reconnect_info(Msg, TrUserData) ->
    e_msg_reconnect_info(Msg, <<>>, TrUserData).


e_msg_reconnect_info(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{passed := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
e_mfield_streaming_input_call_request_payload(Msg, Bin,
					      TrUserData) ->
    SubBin = e_msg_payload(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_streaming_input_call_request_expect_compressed(Msg,
							Bin, TrUserData) ->
    SubBin = e_msg_bool_value(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
e_mfield_streaming_output_call_request_response_parameters(Msg,
							   Bin, TrUserData) ->
    SubBin = e_msg_response_parameters(Msg, <<>>,
				       TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
e_mfield_streaming_output_call_request_response_status(Msg,
						       Bin, TrUserData) ->
    SubBin = e_msg_echo_status(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
decode_msg(Bin, MsgName, Opts) when is_binary(Bin) ->
    ...
    case MsgName of
      bool_value ->
	  try d_msg_bool_value(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, bool_value, {Class, Reason, StackTrace}}}})
	  end;
      payload ->
      ...
      streaming_input_call_request ->
	  try d_msg_streaming_input_call_request(Bin, TrUserData)
	  catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, streaming_input_call_request,
			 {Class, Reason, StackTrace}}}})
	  end;
      reconnect_params ->
	  try d_msg_reconnect_params(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, reconnect_params, {Class, Reason, StackTrace}}}})
	  end;
      echo_status ->
	  try d_msg_echo_status(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, echo_status, {Class, Reason, StackTrace}}}})
	  end;
      response_parameters ->
	  try d_msg_response_parameters(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, response_parameters,
			 {Class, Reason, StackTrace}}}})
	  end;
      streaming_output_call_request ->
	  try d_msg_streaming_output_call_request(Bin, TrUserData)
	  catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, streaming_output_call_request,
			 {Class, Reason, StackTrace}}}})
	  end;
      empty ->
	  try d_msg_empty(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, empty, {Class, Reason, StackTrace}}}})
	  end;
      simple_request ->
	  try d_msg_simple_request(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, simple_request, {Class, Reason, StackTrace}}}})
	  end;
      simple_response ->
	  try d_msg_simple_response(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, simple_response, {Class, Reason, StackTrace}}}})
	  end;
      streaming_output_call_response ->
	  try d_msg_streaming_output_call_response(Bin,
						   TrUserData)
	  catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, streaming_output_call_response,
			 {Class, Reason, StackTrace}}}})
	  end;
      streaming_input_call_response ->
	  try d_msg_streaming_input_call_response(Bin, TrUserData)
	  catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, streaming_input_call_response,
			 {Class, Reason, StackTrace}}}})
	  end;
      reconnect_info ->
	  try d_msg_reconnect_info(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, reconnect_info, {Class, Reason, StackTrace}}}})
	  end
    end.



d_msg_bool_value(Bin, TrUserData) ->
...
d_msg_streaming_input_call_request(Bin, TrUserData) ->
...
d_field_streaming_input_call_request_payload(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   ...
			   {id(d_msg_payload(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
...
d_field_streaming_input_call_request_expect_compressed(<<0:1,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_bool_value(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_streaming_input_call_request(RestF,
						    0, 0, F@_1,
...
d_msg_reconnect_params(Bin, TrUserData) ->
...
d_msg_echo_status(Bin, TrUserData) ->
...
d_msg_response_parameters(Bin, TrUserData) ->
...
d_msg_streaming_output_call_request(Bin, TrUserData) ->
...
d_field_streaming_output_call_request_response_parameters(<<0:1,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_response_parameters(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_streaming_output_call_request(RestF,
...
d_field_streaming_output_call_request_response_status(<<0:1,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_echo_status(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_streaming_output_call_request(RestF,
						     0, 0, F@_1, F@_2, F@_3,
...
d_msg_simple_request(Bin, TrUserData) ->
...
d_msg_simple_response(Bin, TrUserData) ->
...
d_msg_streaming_output_call_response(Bin, TrUserData) ->
...
d_msg_streaming_input_call_response(Bin, TrUserData) ->
...
d_msg_reconnect_info(Bin, TrUserData) ->
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      bool_value ->
	  v_msg_bool_value(Msg, [bool_value], TrUserData);
      payload -> v_msg_payload(Msg, [payload], TrUserData);
      streaming_input_call_request ->
	  v_msg_streaming_input_call_request(Msg,
					     [streaming_input_call_request],
					     TrUserData);
      reconnect_params ->
	  v_msg_reconnect_params(Msg, [reconnect_params],
				 TrUserData);
      echo_status ->
	  v_msg_echo_status(Msg, [echo_status], TrUserData);
      response_parameters ->
	  v_msg_response_parameters(Msg, [response_parameters],
				    TrUserData);
      streaming_output_call_request ->
	  v_msg_streaming_output_call_request(Msg,
					      [streaming_output_call_request],
					      TrUserData);
      empty -> v_msg_empty(Msg, [empty], TrUserData);
      simple_request ->
	  v_msg_simple_request(Msg, [simple_request], TrUserData);
      simple_response ->
	  v_msg_simple_response(Msg, [simple_response],
				TrUserData);
      streaming_output_call_response ->
	  v_msg_streaming_output_call_response(Msg,
					       [streaming_output_call_response],
					       TrUserData);
      streaming_input_call_response ->
	  v_msg_streaming_input_call_response(Msg,
					      [streaming_input_call_response],
					      TrUserData);
      reconnect_info ->
	  v_msg_reconnect_info(Msg, [reconnect_info], TrUserData);
      _ -> mk_type_error(not_a_known_message, Msg, [])
    end.


-dialyzer({nowarn_function,v_msg_bool_value/3}).
v_msg_bool_value(#{} = M, Path, _) ->
    case M of
...
v_msg_reconnect_params(#{} = M, Path, _) ->
    case M of
      #{max_reconnect_backoff_ms := F1} ->
...
v_msg_streaming_input_call_response(#{} = M, Path, _) ->
    case M of
      #{aggregated_payload_size := F1} ->
...
get_msg_names() ->
    [bool_value, payload, streaming_input_call_request,
     reconnect_params, echo_status, response_parameters,
     streaming_output_call_request, empty, simple_request,
     simple_response, streaming_output_call_response,
     streaming_input_call_response, reconnect_info].
