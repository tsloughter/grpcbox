...
-export_type(['reconnect_params'/0, 'bool_value'/0, 'response_parameters'/0, 'echo_status'/0, 'payload'/0, 'simple_request'/0, 'simple_response'/0, 'streaming_output_call_request'/0, 'streaming_output_call_response'/0, 'reconnect_info'/0, 'streaming_input_call_request'/0, 'streaming_input_call_response'/0]).

-spec encode_msg(reconnect_params() | bool_value() | response_parameters() | echo_status() | payload() | simple_request() | simple_response() | streaming_output_call_request() | streaming_output_call_response() | reconnect_info() | streaming_input_call_request() | streaming_input_call_response(),reconnect_params | bool_value | response_parameters | echo_status | payload | simple_request | simple_response | streaming_output_call_request | streaming_output_call_response | reconnect_info | streaming_input_call_request | streaming_input_call_response) -> binary().
...
get_msg_names() ->
    [reconnect_params, bool_value, response_parameters,
     echo_status, payload, simple_request, simple_response,
     streaming_output_call_request,
