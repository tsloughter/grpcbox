...
-export_type(['bool_value'/0, 'payload'/0, 'streaming_input_call_request'/0, 'reconnect_params'/0, 'echo_status'/0, 'response_parameters'/0, 'streaming_output_call_request'/0, 'simple_request'/0, 'simple_response'/0, 'streaming_output_call_response'/0, 'streaming_input_call_response'/0, 'reconnect_info'/0]).

-spec encode_msg(bool_value() | payload() | streaming_input_call_request() | reconnect_params() | echo_status() | response_parameters() | streaming_output_call_request() | simple_request() | simple_response() | streaming_output_call_response() | streaming_input_call_response() | reconnect_info(),bool_value | payload | streaming_input_call_request | reconnect_params | echo_status | response_parameters | streaming_output_call_request | simple_request | simple_response | streaming_output_call_response | streaming_input_call_response | reconnect_info) -> binary().
...
get_msg_names() ->
    [bool_value, payload, streaming_input_call_request,
     ...
     streaming_output_call_request, simple_request,
